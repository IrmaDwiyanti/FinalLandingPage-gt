...
// Rute untuk mengubah bahasa
Route::get('/change-language/{lang}', [LangController::class, 'change'])->name('changeLang');

// Rute untuk halaman utama (membutuhkan middleware lang)
...
// Rute untuk menerjemahkan teks
Route::get('translate/{text}', [LangController::class, 'translate'])->name('translate');
